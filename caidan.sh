    ...
    7)
        ...
        while true; do
            ...
            function install_chatgpt() {
                ...
                # 图标
                wget -qN -P /var/www/html/img/png https://github.com/LX-webo/hinas/blob/main/chatgpt.png
...
EOF
                ...
                4)
                    #清理阿里云缓存
                    bash -c "$(curl -s https://github.com/LX-webo/hinas/blob/main/aliyun_clear.sh | tail -n +2)" -s 5
                    echo "按任意键继续..."
                    read -n 1 -s -r -p ""
                    ;;
                q | Q)
            ...
            function Lucky() {
                ...
                # 图标
                wget -qN -P /var/www/html/img/png https://github.com/LX-webo/hinas/blob/main/lucky.png
...
EOF
            ...
            function UptimeKuma() {
                ...
                # 图标
                wget -qN -P /var/www/html/img/png https://github.com/LX-webo/hinas/blob/main/UptimeKuma.png
...
EOF
    ...
    8)
        ...
        # 图标
        wget -qN -P /var/www/html/img/png https://github.com/LX-webo/hinas/blob/main/cockpit.png
    ...
    9)
        ...
        while true; do
            ...
            1)
                ...
                if [ ! -f "$file" ]; then
                    # 文件不存在，执行下载
                    wget -q https://github.com/LX-webo/hinas/blob/main/"$file"
                else
                    # 文件已存在，不输出
                    wget -q --spider https://github.com/LX-webo/hinas/blob/main/"$file"
                fi
